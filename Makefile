...
.PHONY: ethmonitor geth android ios geth-cross evm all test clean
...
ethmonitor:
	go build -i -o ./build/bin/ethmonitor ./cmd/ethmonitor
	@echo "Done building."
	@echo "Run \"$(GOBIN)/ethmonitor\" to launch ethmonitor."
